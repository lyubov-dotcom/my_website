...
const projects: Project[] = [
  { title: 'Aurora Banking', category: 'Product Design', year: '2025', accent: '#7c5cff' },
      ...
      <main>
            ...
            {projects.map((p) => (
              <article className="project-card" key={p.title}>
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${p.accent}, transparent 140%)`,
                  }}
                >
        ...
        <section id="about" className="about">
          ...
          <p className="about-copy">
            ...
            teams to ship interfaces that feel effortless. My work blends
            rigorous systems thinking with an eye for craft — typography,
            motion, and the small details that make a product sing.
          </p>
        </section>
